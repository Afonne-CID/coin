            ...
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                ...
                <li class="nav-item dropdown hidden-caret submenu">
                    ...
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <div class="scroll-wrapper dropdown-user-scroll scrollbar-outer" style="position: relative;"><div class="dropdown-user-scroll scrollbar-outer scroll-content" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 274.828px;">
                            <li>
                                <div class="user-box">
                            ...
                            <li>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" name="logout" id="logout" role="button" href="?action=server.php">Logout</a>
                            </li>
