            ...
            <div class="row justify-content-center user-auth">
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                    ...
                    <div class="card ">
                        ...
                        <form method="POST" action="register.php" class="mt-5 card__form">
                            <?php include('errors.php'); ?>
                            <input type="hidden" name="_token" value="4O5zuCAY8DypYjxUxpfYbPOdz8zAZIeLdsrI1JxR">                            <div class="form-row">
                            ...
                            <div class="form-row">
                                    ...
                                    <input type="password" class="form-control" name="password_1" id="password_1" placeholder="Enter Password">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="confirm-password">Confirm Password</label>
                                    <input type="password" class="form-control" name="password_2" value="" id="password_2" placeholder="Confirm Password">
                                </div>
                            </div>
                            
                            
                            <div class="form-group">
                                <label for="pgram" name="pgram">Program Type</label>
                                <select class="form_control" name="pgram" id="pgram" required="">
                                    <option selected="" disabled="">Choose Program Type</option>
                                        <option value="Normal">Normal program 
</option>
                                        <option value="Private">Private program(affiliated)</option>
                            ...
                            <div class="form-group">
                                <button name="reg_user" class="mt-4 btn btn-primary" type="submit">Register</button>
                            </div>
    
                            <div class="mb-3 text-center">
                                <small class="mb-2 text-center ">Already have an Account  <a href="login.php">Login.</a> </small>
