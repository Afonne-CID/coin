...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
 ...
 <title> Your Earnings | Coinmarkettrading </title>
		 ...
		 <li class="nav-item">
          ...
          <li class="nav-item dropdown   active ">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item  active " href="earnings.php">Earnings</a>
        ...
        <div class="col-md-12 col-lg-8">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="coinBTC" role="tabpanel">
                  <h2 class="wallet-title">Your Earnings</h2>
                    ...
                    <div class="crypt-market-status">
                        <div>
                            <ul class="nav nav-tabs">
                                <li role="presentation"><a href="#active-orders" class="active" data-toggle="tab">Your Earnings from Trades
</a></li>
                              ...
                              <table class="table no-margin table-hover">
                                <thead>					
                                  <tr class="bg-dark">
                                        ...
                                        <th class="text-yellow" scope="col">Trade ID</th>
                                        <th class="text-yellow" scope="col">Amount</th>
                                        <th class="text-yellow" scope="col">Profits</th>
                                        <th class="text-yellow" scope="col">Earnings</th>
                                        <th class="text-yellow" scope="col">Date Earned</th>                                        
                                  </tr>
                                </thead>
                                <tbody>
                                                                                    <tr>
